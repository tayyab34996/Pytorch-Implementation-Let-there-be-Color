# -*- coding: utf-8 -*-
"""
Data loader port: this mirrors the original `data.py` behaviour and
returns NumPy arrays so the training loop can convert them to PyTorch
tensors without changing dataset semantics.
"""
...
class DATA():
    ...
    def generate_batch(self):
        ...
        for i in range(self.batch_size):
            # Keep the same (odd) join behavior as original to avoid changing paths
